...
* The original package name 'LLD.Design.Tomato Food Delivery Application' is invalid and this project uses 'LLD.Design.Tomato.Food.Delivery.Application' instead.
